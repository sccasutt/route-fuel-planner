...
// Constants reused from the page
...
export function useProcessWahooCallback({ setStatus, setError }: UseProcessWahooCallbackOptions) {
  ...
  }, [navigate, toast, location.search, setStatus, setError]);
